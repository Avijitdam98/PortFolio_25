...
const Skills = () => {
  const skillsData = [
    ...
    },
    {
      ...
      title: "UI/UX Design",
      description: "Designing intuitive user experiences and beautiful interfaces with modern design tools.",
      progress: 88,
      tags: [
        { name: "Figma", level: 88 },
    ...
    },
    {
      ...
      title: "Modern CSS",
      description: "Creating beautiful, responsive layouts with modern CSS frameworks and techniques.",
      progress: 90,
      tags: [
            ...
            >
              ...
              <div className="skill-content">
                ...
                <div className="skill-progress-container">
                  <div className="skill-level" style={{ color: skill.color }}>{skill.progress}%</div>
              ...
              <div className="card-decoration">
                ...
                <div className="corner-line" style={{ background: `linear-gradient(to right, ${skill.color}, transparent)` }}></div>
              </div>
            </motion.div>
          ))}
        </motion.div>
